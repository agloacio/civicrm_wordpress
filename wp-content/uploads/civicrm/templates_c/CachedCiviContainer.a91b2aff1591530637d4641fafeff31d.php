 ...
 */
class CachedCiviContainer_a91b2aff1591530637d4641fafeff31d extends Container
{
     ...
     */
    protected function getSortableEntitySpecProviderService()
    {
        return $this->services['Civi\\Api4\\Service\\Spec\\Provider\\SortableEntitySpecProvider'] = new \Civi\Api4\Service\Spec\Provider\SortableEntitySpecProvider();
    }
    ...
    {
        return $this->services['cache.metadata'] = \CRM_Utils_Cache::create(['name' => 'metadata_5_78_0', 'service' => 'metadata', 'type' => [0 => '*memory*', 1 => 'SqlGroup', 2 => 'ArrayCache'], 'withArray' => 'fast']);
    }
    ...
    {
        $this->factories['civi.pipe'] = function () {
            return new \Civi\Pipe\PipeSession();
        };

        return $this->factories['civi.pipe']();
    }
    ...
    protected function getSpecGathererService()
    {
        ...
        $instance->addSpecProvider(($this->services['Civi\\Api4\\Service\\Spec\\Provider\\SortableEntitySpecProvider'] ?? ($this->services['Civi\\Api4\\Service\\Spec\\Provider\\SortableEntitySpecProvider'] = new \Civi\Api4\Service\Spec\Provider\SortableEntitySpecProvider())));
    ...
    {
        return [
            'civicrm_base_path' => 'C:\\Users\\msteigerwald\\source\\repos\\civicrm_wordpress\\civicrm_wordpress\\wp-content\\plugins\\civicrm\\civicrm',
        ];
    }
}
