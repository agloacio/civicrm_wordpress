...
/* Smarty version 5.3.1, created on 2024-10-08 15:45:48
  from 'file:CRM/common/chart.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.3.1',
  'unifunc' => 'content_670553acb05a26_98653767',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ae9546b68edbd579d394d4872d9adf97891d4860' => 
    array (
      0 => 'CRM/common/chart.tpl',
      1 => 1728398441,
      2 => 'file',
    ),
  ),
...
function content_670553acb05a26_98653767 (\Smarty\Template $_smarty_tpl) {
...
while ($_block_repeat) {
  ob_start();
echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('config')->resourceBase;?>
/bower_components/d3/d3.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('config')->resourceBase;?>
/bower_components/crossfilter2/crossfilter.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('config')->resourceBase;?>
/bower_components/dc-2.1.x/dc.min.js"><?php echo '</script'; ?>
>
<style src="<?php echo $_smarty_tpl->getValue('config')->resourceBase;?>
...
function createChart( chartID, divName, xSize, ySize, data ) {
  ...
  linkSVG.href = '#';
  linkSVG.textContent = '<?php $_block_repeat=true;
...
while ($_block_repeat) {
  ob_start();
?>Download chart (SVG)<?php $_block_repeat=false;
...
?>';
  ...
  linkPNG.href = '#';
  linkPNG.textContent = '<?php $_block_repeat=true;
if (!$_smarty_tpl->getSmarty()->getBlockHandler('ts')) {
throw new \Smarty\Exception('block tag \'ts\' not callable or registered');
}
...
while ($_block_repeat) {
  ob_start();
?>Download chart (PNG)<?php $_block_repeat=false;
echo $_smarty_tpl->getSmarty()->getBlockHandler('ts')->handle(array('escape'=>"js"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
?>';
