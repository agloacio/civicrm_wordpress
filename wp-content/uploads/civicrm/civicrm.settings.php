...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define('CIVICRM_UF_DSN', 'mysql://registrationaglo:u%2A2kDNS6@localhost/civicrm_wordpress?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.private']['path'] = 'C:\\Users\\msteigerwald\\source\\repos\\civicrm_wordpress\\civicrm_wordpress/wp-content/uploads\\civicrm';
$civicrm_paths['wp.frontend.base']['url'] = 'http://localhost:4366/';
$civicrm_paths['wp.backend.base']['url'] = 'http://localhost:4366/wp-admin/';
$civicrm_setting['domain']['userFrameworkResourceURL'] = 'http://localhost:4366/wp-content/plugins/civicrm/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://registrationaglo:u%2A2kDNS6@localhost/civicrm_wordpress?new_link=true');
  }
}
...
$civicrm_root = 'C:\\Users\\msteigerwald\\source\\repos\\civicrm_wordpress\\civicrm_wordpress\\wp-content\\plugins\\civicrm/civicrm\\';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define('CIVICRM_TEMPLATE_COMPILEDIR', 'C:\\Users\\msteigerwald\\source\\repos\\civicrm_wordpress\\civicrm_wordpress/wp-content/uploads\\civicrm\\templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define('CIVICRM_UF_BASEURL', 'http://localhost:4366');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define('CIVICRM_SITE_KEY', 'dori2gRnYXY329Bs1Tgiecq0jnebmK02663j9oa51yM');
}
...
if (!defined('CIVICRM_CRED_KEYS')) {
  define('_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:A5kRmNKplfAzmOi4i01hMKGrGc6AXREUdq0xsCv6YliNdj9Zw');
...
if (!defined('CIVICRM_DEPLOY_ID')) {
  define('_CIVICRM_DEPLOY_ID', 'K2MloeuGxfJIrA');
...
if (!defined('CIVICRM_SIGN_KEYS')) {
  define('_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:VyiGj7Q2nemOrg90U5dIXhkighyAMoYEeiTMG3NHlsyxIqlx93Lg');
...
// define('CIVICRM_MAIL_LOG', 'C:\\Users\\msteigerwald\\source\\repos\\civicrm_wordpress\\civicrm_wordpress/wp-content/uploads\\civicrm\\templates_c/mail.log');
// }
