...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define('CIVICRM_UF_DSN', 'mysql://dbusername:dbpassword@localhost/civicrm_wordpress?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://dbusername:dbpassword@localhost/civicrm_wordpress?new_link=true');
  }
}
